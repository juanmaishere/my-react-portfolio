...
function About() {
    ...
    const introText = "Hi! My name is Juan Manuel Rivera, and I'm a Software and Frontend Developer based in Uruguay with a strong passion for designing and creating websites that provide a unique user experience. With a keen eye for detail and a strong interest in the IT world, I have been part of projects that have given me the necessary knowledge to create applications from scratch, develop my soft skills, and work in multidisciplinary groups. I'm currently using HTML, CSS, JavaScript, and Astro as the primary technologies in my projects, but I also possess expertise in backend technologies like Node.js, Flutter, Google Cloud Platform (GCP), and PostgreSQL.";
